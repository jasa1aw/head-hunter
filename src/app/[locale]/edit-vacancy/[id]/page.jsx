...
export default function EditVacancy() {
    ...
    useEffect(() => {
        if (vacancy) {
            ...
            setSpecialization(vacancy.specializationId || undefined);
            setSpecializationName(vacancy.specialization?.name || '');
            setCity(vacancy.cityId || undefined);
            setSalaryFrom(vacancy.salary_from || '');
            setSalaryTo(vacancy.salary_to || '');
            setSalaryType(vacancy.salary_type || 'KZT');
            setAddress(vacancy.address || '');
            setExperienceId(vacancy.experienceId || undefined);
            setDescription(vacancy.description || "<h2>Обязаности</h2> <ul><li></li><li></li></ul><h2>Требования</h2> <ul><li></li><li></li></ul><h2>Условия</h2> <ul><li></li><li></li></ul>");
            setSelectedSkills(vacancy.skills || []);
            setEmploymentType(vacancy.employmentTypeId || undefined);
        }
    }, [dispatch, id, vacancy]);
            ...
            <main>
                <div className="container p7">
                    ...
                    <fieldset className="fieldset-vertical fieldset-md">
                        ...
                        <div>
                        {empTypes.length && empTypes.map((et) => (
                            <div className="radio" key={et.id}>
                                <input 
                                    type="radio"
                                    key={et.id == employmentTypeId}
                                    checked={et.id == employmentTypeId} 
                                    value={et.id} 
                                    name="empType" 
